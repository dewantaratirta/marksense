...
return [
    ...
    | aturan ukuran. Silakan ubah masing-masing pesan ini sesuai kebutuhan Anda.
    |
    */
    ...
    'hex_color' => 'Kolom :attribute harus berupa warna hexadecimal yang sah.',
...
Kolom :attribute dilarang kecuali :other ada di :values.',
    ...
    | menentukan baris pesan khusus untuk aturan atribut tertentu.
    |
    */
    ...
    | dengan sesuatu yang lebih mudah dibaca seperti "Alamat E-Mail" sebagai
    | gantinya "email". Ini hanya membantu kami membuat pesan kami lebih ekspresif.
    |
    */
